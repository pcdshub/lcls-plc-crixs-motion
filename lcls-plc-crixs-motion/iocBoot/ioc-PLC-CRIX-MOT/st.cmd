...
# Project version: 0fa47ae
#    Project hash: 0fa47ae822dad02be58b2066d2d21aa3865fed3b
...
epicsEnvSet("ADS_MAX_PARAMS",   "6605")
...
epicsEnvSet("DESC",            "Main.M19 / Axis 19 - SDS Rotation Y")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "CRIX:SDS:MMS:")
epicsEnvSet("MOTOR_NAME",      "SHROUD")
epicsEnvSet("DESC",            "Main.M20 / Axis 20 - SDS Shroud Rotation")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "CRIX:BEAM:MMS:")
epicsEnvSet("MOTOR_NAME",      "Z")
epicsEnvSet("DESC",            "Main.M32 / Beam Z")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:CRIX:MOT,PROJECT=lcls-plc-crixs-motion.tsproj,HASH=0fa47ae,VERSION=0fa47ae,PYTMC=2.15.1,PLC_HOST=172.21.140.200")

#   LCLS General: * -> 2.6.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CRIX:MOT,DEPENDENCY=LCLS_General,VERSION=2.6.0,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 2.0.1 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CRIX:MOT,DEPENDENCY=lcls-twincat-motion,VERSION=2.0.1,VENDOR=SLAC")
#   PMPS: * -> 3.0.14 (SLAC - LCLS)
